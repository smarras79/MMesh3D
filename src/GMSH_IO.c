...
*/
{
	...
	{
	    fprintf ( stderr, " #\n" );
	    fprintf ( stderr, " # ---- !!!! GMSH GRID ERROR!!!!!\n" );
...
void gmsh_size_read ( char *gmsh_filename, int *node_num, int *node_dim, int *element_num, int *element_order )
...
*/
{
    ...
    *node_dim = 0;
    ...
    //store global value of nnodes (low order)
    nnodes = *node_num;
